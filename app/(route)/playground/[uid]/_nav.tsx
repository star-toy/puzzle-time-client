      ...
      <div className="w-full h-full flex flex-row items-center justify-between py-[15px] px-[38px] bg-[rgba(166,80,67,1)] shadow-[0px_10px_10px_0px_rgba(0,0,0,0.25)]">
        <div className="flex flex-row items-center gap-[35px]">
          <Link href={URLS.getMainPage()}>
            <Image src="https://s3.ap-northeast-2.amazonaws.com/puzzletime.fun/assets/logo.png" alt="Puzzle Time" width={70} height={70} />
          </Link>
  ...
  return (
    <div className="flex flex-row items-center gap-[10px]">
      ...
      >
        {autoSave ? (
          <Image
            src="https://s3.ap-northeast-2.amazonaws.com/puzzletime.fun/assets/components/ui/switch-on.png"
            alt="AUTOSAVE on"
            width={100}
            height={50}
          ...
          <Image
            src="https://s3.ap-northeast-2.amazonaws.com/puzzletime.fun/assets/components/ui/switch-off.png"
            alt="AUTOSAVE off"
            width={100}
            height={50}
            className="cursor-pointer"
...
function ButtonSave({ isGameStarted }: { isGameStarted: boolean }) {
  return (
    <div className="">
      <Image
        src="https://s3.ap-northeast-2.amazonaws.com/puzzletime.fun/assets/components/ui/icon-save.png"
        alt="SAVE"
        width={50}
        height={50}
        className="cursor-pointer"
...
function ButtonPuzzlePieceNumber({ onClick }: { onClick: () => void }) {
  return (
    <div className="">
      <Image
        src="https://s3.ap-northeast-2.amazonaws.com/puzzletime.fun/assets/components/ui/icon-puzzle-pieces-number.png"
...
function ButtonEdgePieces({ isGameStarted, onClick }: { isGameStarted: boolean; onClick: () => void }) {
  return (
    <div className="">
      <Image
        src="https://s3.ap-northeast-2.amazonaws.com/puzzletime.fun/assets/components/ui/icon-edge-puzzles.png"
        alt="EDGE PUZZLES"
        width={50}
        height={50}
...
function ButtonPreviewArtwork() {
  return (
    <div className="">
      <Image
        src="https://s3.ap-northeast-2.amazonaws.com/puzzletime.fun/assets/components/ui/icon-preview-artwork.png"
        alt="PREVIEW ARTWORK"
        width={50}
        height={50}
        className="cursor-pointer"
...
function ButtonRearrangePieces({ isGameStarted, onClick }: { isGameStarted: boolean; onClick: () => void }) {
  return (
    <div className="">
      <Image
        src="https://s3.ap-northeast-2.amazonaws.com/puzzletime.fun/assets/components/ui/icon-rearrange-pieces.png"
...
function SoundVolume() {
  ...
  return (
    <div className="flex flex-row items-center gap-[20px]">
      <Image
        src="https://s3.ap-northeast-2.amazonaws.com/puzzletime.fun/assets/components/ui/icon-circle-plus.png"
        alt="VOLUME UP"
        width={50}
        height={50}
      ...
      <Image
        src="https://s3.ap-northeast-2.amazonaws.com/puzzletime.fun/assets/components/ui/icon-circle-minus.png"
        alt="VOLUME DOWN"
        width={50}
        height={50}
